...
export function WorkspaceModeTabs({
  ...
  return (
    <AstryxSegmentedControl
      ...
      className="apple-mode-tabs flex w-full min-w-0 flex-row rounded-[16px] bg-[#f1f5f9] p-1 dark:bg-white/[0.06]"
      buttonClassName="apple-mode-tab inline-flex min-h-[32px] min-w-0 flex-1 items-center justify-center gap-1.5 rounded-[12px] px-2 text-left text-[14px] outline-none focus-visible:ring-2 focus-visible:ring-black/10 dark:focus-visible:ring-white/20"
      indicatorClassName="apple-mode-indicator rounded-[12px]"
